<div class="container-fluid">
    ...
    <table class="table table-hover table-bordered table-striped">
        ...
        <?php foreach ($detail as $dt) : ?>
            ...
            <tr>
                <td class="table-primary">Nilai Skripsi</td>
                <td class="table-primary"> <b><?php echo (isset($dt->nilskripsi_kuji_k) ? $dt->nilskripsi_kuji_k : ''); ?></b></td>
            </tr>

            <tr>
                <td class="table-primary">Nilai Ujian Skripsi</td>
                <td class="table-primary"> <b><?php echo (isset($dt->nilskripsi_kuji_u) ? $dt->nilskripsi_kuji_u : ''); ?></b></td>
            </tr>
    ...
    <?php echo anchor(
        'administrator/lihat_nilskripsi',
