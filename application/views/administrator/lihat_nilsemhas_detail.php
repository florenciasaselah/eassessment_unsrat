<div class="container-fluid">
    ...
    <table class="table table-hover table-bordered table-striped">
        ...
        <?php foreach ($detail as $dt) : ?>
            ...
            <tr>
                <td class="table-primary">Nilai Seminar Hasil</td>
                <td class="table-primary"> <b><?php echo (isset($dt->nilsemhas_total) ? $dt->nilsemhas_total : ''); ?></b></td>
            </tr>
