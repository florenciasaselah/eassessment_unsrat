<div class="container-fluid">
    ...
    <div class="alert alert-dark" role="alert">
        <h4> <strong>Nilai Ujian Skripsi </strong> </h4>
    </div>

    <?php echo $this->session->flashdata('pesan'); ?>

    <div class="navbar-form navbar-right mb-4">
        <?php echo form_open('administrator/lihat_nilskripsi/search', array('class' => 'form-inline')) ?>
    ...
    <table class="table table-bordered table-striped table-hovered">
        ...
        foreach ($nilskripsi_kuji as $nsj) : ?>
            <tr>
                ...
                <td width="20px">
                    <?php echo anchor(
                        'administrator/lihat_nilskripsi/detail/' . (isset($nsj->id_nilskripsi_kuji) ? $nsj->id_nilskripsi_kuji : ''),
