<div class="container-fluid">
    ...
    <div class="alert alert-dark" role="alert">
        <h4> <strong>Penilaian Seminar Hasil </strong> </h4>
    </div>

    <?php echo $this->session->flashdata('pesan'); ?>

    <div class="navbar-form navbar-right mb-4">
        <?php echo form_open('administrator/nilsemhas/search', array('class' => 'form-inline')) ?>
    ...
    <table class="table table-bordered table-striped table-hovered">
        ...
        foreach ($nilsemhas as $nsh) : ?>
            <tr>
                ...
                <td width="20px">
                    <?php echo anchor(
                        'administrator/nilsemhas/detail/' . (isset($nsh->id_nilsemhas) ? $nsh->id_nilsemhas : ''),
                ...
                <td width="20px">
                    <?php echo anchor(
                        'administrator/nilsemhas/update/' . (isset($nsh->id_nilsemhas) ? $nsh->id_nilsemhas : ''),
