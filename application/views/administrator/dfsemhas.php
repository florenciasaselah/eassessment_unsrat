<div class="container-fluid">
    ...
    <div class="alert alert-dark" role="alert">
        <h4> <strong>Kelola Seminar Hasil </strong> </h4>
    </div>

    <div class="navbar-form navbar-left mb-4">
        <?php echo form_open('administrator/dfsemhas/search', array('class' => 'form-inline')) ?>
    ...
    <?php echo anchor('administrator/dfsemhas/input', '<button class="btn btn-sm btn-primary mb-3">
    ...
    <table class="table table-bordered table-striped table-hovered">
        ...
        foreach ($dfsemhas as $dfs) : ?>
            <tr>
                ...
                <td width="20px"><?php echo anchor('administrator/dfsemhas/detail/'
                                        . $dfs->id_semhas, '<div class="btn btn-sm btn-info">
                <i class="fa fa-eye"></i></div>') ?> </td>
                <td width="20px"><?php echo anchor('administrator/dfsemhas/update/'
                ...
                <td width="20px" onclick="javascript: return confirm('Anda yakin ingin menghapus?')">
                    <?php echo anchor(
                        'administrator/dfsemhas/delete/' . $dfs->id_semhas,
